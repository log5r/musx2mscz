"""Translation helpers vendored from musx2mxl (MIT License,
Copyright (c) Joris Van Eyghen, https://github.com/joris-vaneyghen/musx2mxl),
with minor adaptations for musx2mscz."""
...
ENGRAVER_CHAR_MAP_CLEFS = {
    ...
    116: ('F', -1),
    160: ('G', 1),
    47: ('percussion', 0),   # Kousaku/Rentaro percussion clef
    139: ('percussion', 0),
...
with importlib.resources.files("musx2mscz.data").joinpath("instruments.json").open() as json_file:
